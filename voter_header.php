...
<header class="main__header">
    <div class="container">
        <nav class="navbar navbar-default" role="navigation">
            ...
            <div class="menuBar">
                <ul class="menu">
                    <li class="active"><a href="voter_home.php">Home</a></li>


                    <li><a href="logout_voter.php">Logout</a></li>
                    <li><a>
                            <span style="float: right;font-size: larger">
                                <?php
                                include "connection.php";
                                $select="select name,fname from voter where adhaar=".$_SESSION['adhaar'];
                                $res=mysqli_query($conn,$select);
                                $row=mysqli_fetch_array($res);
                                echo "Logged In as : ".$row[0]."<br>
                                    Father's Name : ".$row[1];
                                ?>
                            </span>
                        </a></li>
