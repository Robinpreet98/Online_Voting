            ...
            <div class="menuBar">
                <ul class="menu">
                    ...
                    <li class="dropdown"><a href="#">Admin</a>
                        <ul>
                            <li><a href="addadmin.php">Create New Admin</a></li>
                            <li><a href="view_admin.php">View Admins</a></li>
                        </ul>
                    </li>
                    <li class="dropdown"><a href="#">Constituency</a>
                        <ul>
                            <li><a href="constituency.php">Add New Constituency</a></li>
                            <li><a href="viewconstituency.php">View Constituencies</a></li>
                        </ul>
                    </li>
                    <li><a href="candidate.php">Add New Candidate</a></li>

                    <li><a href="changepassword_admin.php">Change Password</a></li>
